...
,
    ...
    "Arabic": {
        ...
        "Grade8": ["أَلْهَىٰكُمُ", "ٱلتَّكَاثُرُ", "حَتَّىٰ", "زُرْتُمُ", "ٱلْمَقَابِرَ", "كَلَّا", "سَوْفَ", "تَعْلَمُونَ", "ثُمَّ", "ٱلْيَقِينِ", "لَتَرَوُنَّ", "ٱلْجَحِيمَ", "لَتَرَوُنَّهَا", "ٱلْيَقِينِ", "لَتُسْـَٔلُنَّ", "يَوْمَئِذٍ", "ٱلنَّعِيمِ", "ٱلْقَارِعَةُ", "ٱلْقَارِعَةُ", "أَدْرَىٰكَ", "ٱلْقَارِعَةُ", "ٱلنَّاسُ", "كَٱلْفَرَاشِ", "ٱلْمَبْثُوثِ", "وَتَكُونُ", "ٱلْجِبَالُ", "كَٱلْعِهْنِ", "ٱلْمَنفُوشِ", , "ثَقُلَتْ", "مَوَزِينُهُۥ", "عِيشَةٍۢ", "رَّاضِيَةٍۢ", "خَفَّتْ", "فَأُمُّهُۥ", "هَاوِيَةٌۭ", "أَدْرَىٰكَ", "حَامِيَةٌۢ"],
    },
}
